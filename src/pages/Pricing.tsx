      ...
      <div className="container py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <CardContent>
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <span>Access to Learn section (limited)</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-4 w-4 mr-2 text-green-500" />
          ...
          <Card className="border-primary relative">
            <div className="absolute top-0 right-0 rounded-bl-lg rounded-tr-lg bg-primary px-3 py-1 text-xs text-primary-foreground font-medium">
              Popular
            </div>
            <CardHeader>
              <CardTitle>Professional</CardTitle>
              <div className="text-3xl font-bold">$29<span className="text-lg text-muted-foreground font-normal">/month</span></div>
