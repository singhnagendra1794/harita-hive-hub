-- Update handle_new_user function to include all professional plan emails
...
-- Also grant pro access to any existing users from the list who don't have it yet
