-- Update the is_professional_email function to include all the new professional email addresses
...
-- Update existing users with these emails to have professional access
