-- Enable required extensions and completely fix signup flow
-- Enable pgcrypto extension for random functions
...
-- Create a working handle_new_user function that matches the actual profiles table structure
