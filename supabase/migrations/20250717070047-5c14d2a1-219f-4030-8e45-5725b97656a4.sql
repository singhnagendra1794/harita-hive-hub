-- Add stats columns to profiles table if not already present
...
-- Update the handle_new_user function to initialize clean stats and auto-assign professional plan
