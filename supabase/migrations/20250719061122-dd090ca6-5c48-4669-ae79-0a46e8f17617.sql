-- Update user roles and subscriptions for professional users
-- First, update user subscriptions to ensure all professional emails have pro tier
...
-- Update user profiles to set plan to professional  
